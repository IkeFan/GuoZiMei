...
import com.mmy.guozimei.GuoZiMeiApp;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static       String DB_PATH     = GuoZiMeiApp.instance.getCacheDir()+ "/databases/";
    /*
